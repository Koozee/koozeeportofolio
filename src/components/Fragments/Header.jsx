    ...
    return (
        <header className={`fixed transition-all duration-300 ease-in-out bg-transparent py-5 px-3 md:px-10 lg:px-24 flex justify-center items-center w-full h-max z-50 ${showNavbar ? `transform translate-y-0` : 'transform -translate-y-full'}`}>
            <div className="container flex justify-between items-center gap-3 h-max max-w-full">
                ...
                <nav className="z-50 hidden lg:block top-[9%] w-screen md:relative md:top-0 md:w-max bg-slate-100 md:bg-sky-300 px-5 md:rounded-full drop-shadow-xl md:shadow-sky-400/30">
                    <ul className="text-center flex flex-col md:items-center md:flex-row mx-auto px-4 py-5 gap-[4vw]">
                        <li className="text-sm md:text-lg hover:text-white hover:underline hover:underline-offset-8"><a
                            href="#home">Home</a>
                        </li>
                        <li className="text-sm md:text-lg hover:text-white hover:underline hover:underline-offset-8"><a
                ...
                {isOpen && (
                    <nav className="no-doc-scroll z-50 absolute p-5 w-screen h-screen right-0 top-0 bg-sky-200 md:hidden">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex justify-center items-center">
                                <input id="switch" className="sr-only input" type="checkbox" />
                        ...
                        <ul className="w-full h-full text-center flex flex-col justify-center items-center gap-10">
                            <li onClick={toogleNavbar} className="text-2xl hover:text-white hover:underline hover:underline-offset-8"><a
                                href="#home">Home</a>
                            </li>
                            <li onClick={toogleNavbar} className="text-2xl hover:text-white hover:underline hover:underline-offset-8"><a
                                href="#about">About Me</a></li>
