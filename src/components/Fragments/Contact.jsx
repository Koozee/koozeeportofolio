        ...
        <section id="contact" className="2xl:px-72 xl:px-48 px-5 dark:bg-slate-800 pb-10">
            ...
            <div className="container lg:flex justify-between items-center">
                ...
                <div className="relative mb-5 mx-auto xl:mx-0 duration-300 hover:-rotate-0 -rotate-12 group border-sky-900 border-4 overflow-hidden rounded-2xl h-1/3 w-[70vw] md:w-1/2 lg:w-1/3 xl:w-[35%] bg-sky-800 p-5 flex flex-col items-start gap-4">
                    ...
                    <a href="https://drive.google.com/file/d/12YW7KEGZbroxvaCQBJNLlEl-LPMrkKpA/view?usp=sharing" target="_blank" className="duration-300 hover:bg-sky-900 border hover:text-gray-50 bg-gray-50 font-semibold text-sky-800 px-3 py-2 flex flex-row items-center gap-3">Dowload CV
