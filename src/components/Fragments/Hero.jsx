...
export default function Hero(props) {
    return (
        <motion.main id="home" className="flex h-screen bg-gradient-to-tr from-white via-white to-sky-300 dark:bg-gradient-to-br dark:from-slate-500 dark:via-slate-600 dark:to-slate-800 px-5 z-0">
            ...
            <div className="container m-auto flex flex-col justify-center items-center w-max gap-y-4 lg:gap-y-2 2xl:gap-y-5">
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5, duration: 1, easings: ['backOut'] }} className="2xl:mt-10 lg:mt-8 mt-10 grid grid-cols-3 gap-8 lg:gap-16">
                    <ButtonContactHero linkgoto={"mailto:koozeedev@gmail.com"} logo={image.logogmail} />
