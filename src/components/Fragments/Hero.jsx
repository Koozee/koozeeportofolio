  ...
  return (
    ...
    >
      ...
      <div className="container m-auto flex flex-col justify-center items-center w-max gap-y-4 lg:gap-y-2 2xl:gap-y-5">
        <h1 className="text-4xl 2xl:text-5xl  text-purple-600 dark:text-fuchsia-500 font-bold">
          Hello Guys👋,
        </h1>
        <h2 className="text-4xl 2xl:text-6xl text-purple-600 dark:text-fuchsia-500 font-semibold">
          I am Niko Achmad
        </h2>
        <div className="flex gap-x-5 xl:gap-x-6 justify-center">
          <div className="relative w-[39%] lg:w-[30%] 2xl:w-full">
            ...
            <div className="z-0 text-transparent top-0 w-full lg:w-[120%] 2xl:w-full h-[110%] transform -translate-x-2 translate-y-2 -rotate-6 rounded-lg bg-gradient-to-r from-[#5fbdff]/50 to-[#e5f4ff]/50 dark:bg-gradient-to-r dark:from-blue-600/50 dark:to-blue-400/50">
              ------------------------------------------
            </div>
          </div>
        ...
        <p className="font-medium text-slate-600 dark:text-slate-50 text-2xl 2xl:text-3xl text-center lg:w-[60%] mt-5">
        ...
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.5, duration: 1, easings: ["backOut"] }}
